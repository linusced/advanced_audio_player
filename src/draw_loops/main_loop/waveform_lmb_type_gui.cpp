...
void MainLoop::createWaveformLmbTypeGUI()
{
    ...
    waveformLmbTypeArr.back().btn = std::make_unique<lc_gui::ButtonElement>("waveform-lmb-type-btn waveform-lmb-type-btn-active", "btn-click", waveformLmbTypeCallback);
    ...
    waveformLmbTypeArr.push_back(WaveformLmbType());
    waveformLmbTypeArr.back().btn = std::make_unique<lc_gui::ButtonElement>("waveform-lmb-type-btn", "btn-click", waveformLmbTypeCallback);
