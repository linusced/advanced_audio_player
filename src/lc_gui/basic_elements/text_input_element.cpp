...
lc_gui::TextInputElement::TextInputElement(TextRenderer::Font *font, std::string text, const std::string &className, std::function<void(TextInputElement *, std::string &)> callback)
